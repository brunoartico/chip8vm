...
public class FGroupSetDelayTimerOperation implements OperationCodeStrategy {
    public static final int OP_CODE = 0xF015;
    ...
    public void visit(ChipU chipU, GhipU ghipU, Input8 io) {
        chipU.setDelayTimer(chipU.readRegister(register));
    }
}
