...
public class FGroupWaitKeyAndStoreToRegisterOperation implements OperationCodeStrategy {
    public static final int OP_CODE = 0xF00A;
    ...
    public void visit(ChipU chipU, GhipU ghipU, Input8 io) {
        chipU.setRegister(register, io.waitKeyPress());
    }
}
