...
public class EightGroupBitwiseAndOperation implements OperationCodeStrategy {
    public static final int OP_CODE = 0x8002;
    ...
    public void visit(ChipU chipU, GhipU ghipU, Input8 io) {
        ...
        chipU.setRegister(xRegister, (xValue & yValue));
    }
}
