...
public class EightGroupAddToRegistryOperation implements OperationCodeStrategy {
    public static final int OP_CODE = 0x8004;
    ...
    public void visit(ChipU chipU, GhipU ghipU, Input8 io) {
        ...
        chipU.setCarryFlag(((value & 0xFF00) >> 8) > 0);
    }
}
